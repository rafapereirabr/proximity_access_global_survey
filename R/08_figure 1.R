...
# Create horizontal bar charts - want to make a type of tornado plot but havent gotten it right yet

plot_fig1_v1 <- ggplot(df_plot, aes(x = percentage, y = variable, fill = type)) +
...
plot_fig1_v2 <- ggplot(df_plot, aes(x = percentage, y = variable, fill = type)) +
